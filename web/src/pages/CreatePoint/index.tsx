...
const CreatePoint = () => {
    ...
    //Submitting data to the BeauTree API
    ...
    return (
        <div id="page-create-point">
            ...
            <form onSubmit={handleSubmit}>
                <h1>Cadastro do <br /> profissional maquiador</h1>
                ...
                <fieldset>
                    <legend>
                        <h2>Como você irá trabalhar?</h2>
                        <span>Selecione uma ou mais categorias que se encaixam com seu serviço</span>
                    </legend>
